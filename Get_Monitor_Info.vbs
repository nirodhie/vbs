...
'tmpOutput=tmpOutput & "[Monitor_" & cstr(tmpctr+1) & "]"  & "," 
'tmpOutput=tmpOutput & "EDID_VESAManufacturerID=" & tmpResult(1) & vbcrlf
'tmpOutput=tmpOutput & "EDID_DeviceID=" & tmpResult(3) & vbcrlf
tmpOutput=tmpOutput & "EDID_ManufactureDate=" & tmpResult(2) & ","
tmpOutput=tmpOutput & "EDID_SerialNumber=" & tmpResult(0) & ","
tmpOutput=tmpOutput & "EDID_ModelName=" & tmpResult(4) 
...
Set GetWMIRegProvider=GetObject("winmgmts:{impersonationLevel=impersonate}!\\" & "." & "\root\default:StdRegProv")
End Function
